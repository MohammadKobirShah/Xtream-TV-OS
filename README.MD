...
|------|-------------|---------------|-----|----------|
| **Named** | `cloudflared` | ✅ `CLOUDFLARE_TUNNEL_TOKEN` | Your custom domain (e.g. `tv.yourdomain.com`) | Production, permanent |
| **Quick** | `cloudflared-quick` | ❌ None | Random `*.trycloudflare.com` | Testing, demos, ephemeral |
